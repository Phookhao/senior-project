        ...
        <body>
            <section>
                ...
                <div class="2xl:w-full grid items-center justify-center">
                    ...
                    <div class="combo">
                        <input type="text"  id="search" placeholder="ค้นหาคำศัพท์...""
                            class="w-1/2  p-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        {{-- <button type="submit"
                            class="h-[42px] px-2 bg-blue-500 font-thai text-white rounded-r-lg hover:bg-blue-600">ค้นหา</button> --}}
                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        data.forEach(word => {
                            rows += `
                                <tr class="odd:bg-gray-100 even:bg-white hover:bg-gray-200">
                                    ...
                                    <td class="py-2 px-4 border-b">${word.meaning}</td>
                                    <td class="py-2 px-4 border-b">
                                        ${word.audio_file ? 
                                            `<audio controls class="w-32">
                                                <source src="/storage/${word.audio_file}" type="audio/mpeg">
                                                Your browser does not support the audio element.
                                            </audio>` 
                                            : '<span class="text-gray-500">ไม่มีเสียง</span>'
                                        }
                                    </td>
                                </tr>
                            `;
                        ...
                        rows = `<tr><td colspan="4" class="text-center py-4">ไม่พบคำศัพท์</td></tr>`;
                    }
                    $('#wordList').html(rows);
                }
            });
